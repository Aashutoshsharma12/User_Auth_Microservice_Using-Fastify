...
const messages = (data) => {
    ...
    if (data == "en") {
        var messages = {
            ...
            engine_companyAlreadyExist: "Engine company with name:  {{name}}  already exists.",
            engine_modelAlreadyExist: "Engine model with name :  {{name}}  already exists.",
            catAlreadyExist: "Category with name :  {{catName}}  already exists.",
            catNotFound: "Category with this name not exists",
            catShortNameAlreadyExist: "Category with short name: {{catName}}  already exists.",
            subCatShortNameAlreadyExist: "Sub Category with short name: {{catName}}  already exists.",
            sub_subCatAlreadyExist: "Sub-Sub-Category with name: {{catName}}  already exists.",
            ...
            maxLimit: "You uploaded maximum limit {{limit}} ! please remove old ones then upload ",
            invalidPickupAddress: "Not a valid pickup address.",
            invalidDeliveryAddress: "Not a valid delivery address.",
            accountAlreadyExist: "Account with given Phone number and Role already exists.",
            ...
            faq_AlreadyExist: "faq with que :  {{que}}  already exists.",
